IF OBJECT_ID('P_HelpSSRSReport','P') is not null 
    DROP PROC P_HelpSSRSReport 
GO 
 
CREATE PROC P_HelpSSRSReport 
...
--EXEC P_HelpSSRSReport @ReportName = 'Report1',@ShowExecutionLog=0 